...
> **Status: early.** Two tracks are complete — Foundations (8 levels) and Agent core (10) — plus the first Context level: 19 playable end to end. The other 57 are specified but not written yet.
