...
> **Status: early.** Three tracks are complete — Foundations (8 levels), Agent core (10) and Context (8) — plus eight Retrieval levels: 34 playable end to end. The other 42 are specified but not written yet.
