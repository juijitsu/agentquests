...
> **Status: early.** Three tracks are complete — Foundations (8 levels), Agent core (10) and Context (8) — plus four Retrieval levels: 30 playable end to end. The other 46 are specified but not written yet.
