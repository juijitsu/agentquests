...
> **Status: early.** Three tracks are complete — Foundations (8 levels), Agent core (10) and Context (8) — plus five Retrieval levels: 31 playable end to end. The other 45 are specified but not written yet.
