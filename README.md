...
> **Status: early.** Three tracks are complete — Foundations (8 levels), Agent core (10) and Context (8) — plus seven Retrieval levels: 33 playable end to end. The other 43 are specified but not written yet.
