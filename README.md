...
> **Status: early.** Three tracks are complete — Foundations (8 levels), Agent core (10) and Context (8) — plus the first Retrieval level: 27 playable end to end. The other 49 are specified but not written yet.
