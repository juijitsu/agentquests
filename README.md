...
> **Status: early.** Three tracks are complete — Foundations (8 levels), Agent core (10) and Context (8) — plus three Retrieval levels: 29 playable end to end. The other 47 are specified but not written yet.
