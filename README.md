...
> **Status: early.** Four tracks are complete — Foundations (8 levels), Agent core (10), Context (8) and Retrieval (9) — plus three Evaluation levels: 38 playable end to end. The other 38 are specified but not written yet.
