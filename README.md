...
> **Status: early.** Four tracks are complete — Foundations (8 levels), Agent core (10), Context (8) and Retrieval (9) — plus seven Evaluation levels: 42 playable end to end. The other 34 are specified but not written yet.
