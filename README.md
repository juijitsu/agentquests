...
> **Status: early.** Three tracks are complete — Foundations (8 levels), Agent core (10) and Context (8) — plus two Retrieval levels: 28 playable end to end. The other 48 are specified but not written yet.
