...
> **Status: early.** Four tracks are complete — Foundations (8 levels), Agent core (10), Context (8) and Retrieval (9): 35 playable end to end. The other 41 are specified but not written yet.
