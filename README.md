...
> **Status: early.** Three tracks are complete — Foundations (8 levels), Agent core (10) and Context (8) — plus six Retrieval levels: 32 playable end to end. The other 44 are specified but not written yet.
