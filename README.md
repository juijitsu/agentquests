...
> **Status: early.** Two tracks are complete — Foundations (8 levels) and Agent core (10) — plus six Context levels: 24 playable end to end. The other 52 are specified but not written yet.
