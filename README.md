...
> **Status: early.** Four tracks are complete — Foundations (8 levels), Agent core (10), Context (8) and Retrieval (9) — plus two Evaluation levels: 37 playable end to end. The other 39 are specified but not written yet.
