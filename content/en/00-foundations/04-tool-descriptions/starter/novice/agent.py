"""Level 04 · novice. The loop works. One description is ruined."""
...
TOOLS = [
    {
        ...
        # TODO: the description was lost in a migration. The model cannot
        #       recognise the tool by it and picks the neighbour. Write a real one.
